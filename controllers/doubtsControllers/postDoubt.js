...
const addDoubt = asyncHandler(async (req, res) => {
  const { student_id, student_name, subject, class_grade, language, body } =
    req.body;
  ...
  try {
    ...
    await pool.query(
      `INSERT INTO doubts (student_id, tutor_id, 
        ...
        VALUES ($1, NULL, $2, $3, $4, $5, NOW(), $6, NULL)`,
      [student_id, subject, class_grade, language, body, student_name]
    );
